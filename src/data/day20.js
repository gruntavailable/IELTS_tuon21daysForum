...
The central argument for prevention is one of leverage. A single preventive measure operates across an entire population before illness develops, whereas treatment addresses individuals after damage has occurred. Vaccination programmes, clean water systems and tobacco regulation illustrate this mechanism clearly: each removes a cause rather than managing a consequence, and the cost per person affected is therefore extremely low. A national programme reducing smoking rates, for instance, prevents thousands of future cases of cardiovascular and respiratory disease, the treatment of which would otherwise consume decades of costly medical intervention.<br><br>
